                            ...
                            <div class="col-md-3">
                                <div class="navbar-header">
                                    <div class="navbar-brand">
                                        <h1>
                                            <a href="index-2.html">
                                                <img src="{{asset('front_assets')}}/images/Dhaka_University_logo.png" alt="LIBRARIA" width="80px" />
                                            </a>
                                        </h1>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="topbar-info">
                                                <a href="tel:+61-3-8376-6284"><i class="fa fa-phone"></i>01719074099</a>
                                                <span>/</span>
                                                <a href="mailto:support@libraria.com"><i class="fa fa-envelope"></i>rashu_255@yahoo.com.com</a>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="topbar-links">
                                                <a href="{{ url('user/signin') }}"><i class="fa fa-lock"></i>Login / Register</a>
                                                <span>|</span>
                                                <div class="header-cart dropdown">
                                                    ...
                                                    <div class="dropdown-menu cart-dropdown">
                                                        <ul>
                                                            <li class="clearfix">
                                                                <img src="{{asset('front_assets')}}/images/header-cart-image-01.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                            ...
                                                            <li class="clearfix">
                                                                <img src="{{asset('front_assets')}}/images/header-cart-image-02.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="#">The Great Gatsby</a>
                                                                    </div>
                                                            ...
                                                            <li class="clearfix">
                                                                <img src="{{asset('front_assets')}}/images/header-cart-image-03.jpg" alt="cart item" />
                                                                <div class="item-info">
                                                                    <div class="name">
                                                                        <a href="#">The Great Gatsby</a>
                                                                    </div>
                                ...
                                <div class="navbar-collapse hidden-sm hidden-xs">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li class="dropdown">
                                            <a data-toggle="dropdown" class="dropdown-toggle disabled" href="{{ url('books&media/search') }}">Books &amp; Media</a>
                                            <ul class="dropdown-menu">
...
@yield('content')
   ...
   <!-- Start: Footer -->
                ...
                <div class="container">
                    <div class="row">
                        <div class="footer-text col-md-3">
                            <p><a target="_blank" href="https://www.templatespoint.net">TemplatesPoint</a></p>
                        </div>
        ...
        <script type="text/javascript" src="{{asset('front_assets')}}/js/jquery-1.12.4.min.js"></script>
        ...
        <!-- Mobile Menu -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/mmenu.min.js"></script>
        
        <!-- Harvey - State manager for media queries -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/harvey.min.js"></script>
        
        <!-- Waypoints - Load Elements on View -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/waypoints.min.js"></script>

        <!-- Facts Counter -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/facts.counter.min.js"></script>

        <!-- MixItUp - Category Filter -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/mixitup.min.js"></script>

        <!-- Owl Carousel -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/owl.carousel.min.js"></script>
        
        <!-- Accordion -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/accordion.min.js"></script>
        
        <!-- Responsive Tabs -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/responsive.tabs.min.js"></script>
        
        <!-- Responsive Table -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/responsive.table.min.js"></script>
        
        <!-- Masonry -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/masonry.min.js"></script>
        
        <!-- Carousel Swipe -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/carousel.swipe.min.js"></script>
        
        <!-- bxSlider -->
        <script type="text/javascript" src="{{asset('front_assets')}}/js/bxslider.min.js"></script>
