            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('welcome/content')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Post Welcome</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('add/content')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Add New Content</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('content/category')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"></span>Category</a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('blog/post')}}" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu"></span>Blog</a></li>
